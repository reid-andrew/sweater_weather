...
RSpec.describe 'Background Endpoint -', type: :request do
  before(:each) do
    ...
    stub_request(:get, "https://maps.googleapis.com/maps/api/place/findplacefromtext/json?fields=photos&input=%7B%22location%22=%3E%22cleveland,%20oh%22%7D&inputtype=textquery&key=#{ENV['GOOGLE_GEOCODING_KEY']}")
